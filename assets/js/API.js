  ...
  fetch("https://swapi.info/api/planets")
    ...
    .then(data => {
      ...
      for (const item of data.slice(0, 10)) {
        ...
        const figure = document.createElement("figure");
        const img = document.createElement("img");
        img.src = `./assets/planets/${planetImages[name] || "placeholder.jpg"}`;
        img.alt = name;
        ...
        liWrapper.append(figure, ullist);
        ulWrapper.append(liWrapper);
      }
  ...
  fetch("https://swapi.info/api/species")
    ...
    .then(data => {
      ...
      for (const item of data.slice(0, 10)) {
        ...
        const figure = document.createElement("figure");
        const img = document.createElement("img");
        img.src = `./assets/species/${speciesImages[name] || "placeholder.jpg"}`;
        img.alt = name;
  ...
  fetch("https://swapi.info/api/vehicles")
    ...
    .then(data => {
      ...
      for (const item of data) {
        ...
        const figure = document.createElement("figure");
        const img = document.createElement("img");
        img.src = `./assets/vehicles/${vehicleImages[name] || "placeholder.jpg"}`;
        img.alt = name;
        ...
        liClass.className = "vehicleDetail";
        liClass.innerText = `Fartøjsklasse: ${vehicle_class}`;
        ...
        ulInner.append(liModel, liManu, liClass, liCrew, liCargo, liFilms);
        liWrapper.append(figure, ulInner);
        ulWrapper.append(liWrapper);
      }
  ...
  fetch("https://swapi.info/api/starships")
    ...
    .then(data => {
      ...
      for (const item of data) {
        ...
        const figure = document.createElement("figure");
        const img = document.createElement("img");
        img.src = `./assets/starships/${starshipImages[name] || "placeholder.jpg"}`;
        img.alt = name;
